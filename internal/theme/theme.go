...
func Current() Palette {
	...
	p := Palette{
		Base: color(v, "wallbash_pry1", f.Base), Mantle: color(v, "wallbash_pry2", f.Mantle), Crust: color(v, "wallbash_1xa1", f.Crust), Surface0: color(v, "wallbash_1xa2", f.Surface0), Surface1: color(v, "wallbash_1xa3", f.Surface1), Surface2: color(v, "wallbash_1xa4", f.Surface2),
		Overlay0: color(v, "wallbash_1xa5", f.Overlay0), Overlay1: color(v, "wallbash_1xa6", f.Overlay1), Overlay2: color(v, "wallbash_1xa7", f.Overlay2), Subtext0: color(v, "wallbash_1xa8", f.Subtext0), Subtext1: color(v, "wallbash_1xa9", f.Subtext1), Text: color(v, "wallbash_txt1", f.Text),
		Lavender: color(v, "wallbash_3xa8", f.Lavender), Blue: color(v, "wallbash_3xa7", f.Blue), Sapphire: color(v, "wallbash_3xa8", f.Sapphire), Sky: color(v, "wallbash_2xa8", f.Sky), Teal: color(v, "wallbash_2xa7", f.Teal), Green: color(v, "wallbash_2xa9", f.Green), Yellow: color(v, "wallbash_1xa8", f.Yellow), Peach: color(v, "wallbash_1xa9", f.Peach), Red: color(v, "wallbash_4xa8", f.Red), Mauve: color(v, "wallbash_3xa8", f.Mauve), Pink: color(v, "wallbash_2xa8", f.Pink), Rosewater: color(v, "wallbash_4xa9", f.Rosewater),
	}
